...
public class BranchNameUtils {
    ...
    public static String createSnapshotBranchName(final String worldUuid, final Loginator logger) {
    ...
    public static String extractWorldUuid(final String fromSnapshotBranchName, final Loginator logger) {
