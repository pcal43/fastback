...
public class ListSnapshotsTask extends Task {
    ...
    public static Runnable listSnapshotsForWorld(WorldContext world, Consumer<String> sink) {
        ...
        final Loginator logger = world.getModContext().getLogger();
    ...
    private ListSnapshotsTask(Path worldSaveDir, Function<String, String> branchFilter, Consumer<String> sink, Loginator logger) {
