...
public class RetentionStrategyTests {
    ...
    public void testDailyStrat() throws ParseException {
        ...
        final SnapshotId TODAY1 = SnapshotId.fromUuidAndName(uuid, "2022-09-03_02-11-15");
        final SnapshotId TODAY2 = SnapshotId.fromUuidAndName(uuid, "2022-09-03_10-44-19");
        final SnapshotId TODAY3 = SnapshotId.fromUuidAndName(uuid, "2022-09-03_11-11-11");
        ...
        Collection<SnapshotId> pruned = pruner.getSnapshotsToPrune(snapshots);
        Assertions.assertEquals(pruned, Set.of(LAST_YEAR, YESTERDAY, TODAY3, TOMORROW));
    }
